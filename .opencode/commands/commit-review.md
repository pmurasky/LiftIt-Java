...
Reference `engineering-standards/docs/AI_AGENT_WORKFLOW.md` for micro-commit standards and `engineering-standards/docs/CODING_PRACTICES.md` for commit message format.
